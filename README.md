...
|⚠️ Missing credentials - features limited |[link](https://devdocs.magento.com/guides/v2.4/install-gde/prereq/dev_install.html#instgde-prereq-compose-clone-auth)|MDM can not find your ~/.composer/auth.json file. You will not be able to create new apps from the source, but a prepackaged app will still work. The link to doc shows how to create it.|
